...
const applyTheme=theme=>{document.documentElement.dataset.btmTheme=theme;document.documentElement.style.colorScheme=theme==='dark'?'dark':'dark';const b=document.getElementById('btmThemeToggle');if(b){const dark=theme==='dark';b.setAttribute('aria-pressed',dark?'true':'false');b.innerHTML=dark?'☾ DARK':'☼ NORMAL'}};
